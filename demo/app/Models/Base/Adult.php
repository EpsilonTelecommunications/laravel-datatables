...
/**
 * Base class that represents a row from the 'adult' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Adult implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\AdultTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildChild[] Cross Collection to store aggregation of ChildChild objects.
     */
    ...
    /**
     * Initializes internal state of App\Models\Base\Adult object.
     */
    ...
    /**
     * Compares this with another <code>Adult</code> instance.  If
     * <code>obj</code> is an instance of <code>Adult</code>, delegates to
     * <code>equals(Adult)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Adult The current object, for fluid interface
     */
     ...
     * @return $this|\App\Models\Adult The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AdultTableMap::COL_ID] = true;
        }
    ...
    public function setGenderId($v)
    {
        ...
        if ($this->gender_id !== $v) {
            $this->gender_id = $v;
            $this->modifiedColumns[AdultTableMap::COL_GENDER_ID] = true;
        }

        if ($this->aGender !== null && $this->aGender->getId() !== $v) {
            $this->aGender = null;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[AdultTableMap::COL_NAME] = true;
        }
    ...
    public function setDateOfBirth($v)
    {
        ...
        if ($this->date_of_birth !== null || $dt !== null) {
            if ($this->date_of_birth === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_of_birth->format("Y-m-d H:i:s.u")) {
                $this->date_of_birth = $dt === null ? null : clone $dt;
                $this->modifiedColumns[AdultTableMap::COL_DATE_OF_BIRTH] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AdultTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AdultTableMap::translateFieldName('GenderId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gender_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AdultTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AdultTableMap::translateFieldName('DateOfBirth', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = AdultTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\Adult'), 0, $e);
        }
    }
    ...
    {
        if ($this->aGender !== null && $this->gender_id !== $this->aGender->getId()) {
            $this->aGender = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAdultQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAdultQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AdultTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[AdultTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AdultTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(AdultTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AdultTableMap::COL_GENDER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'gender_id';
        }
        if ($this->isColumnModified(AdultTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(AdultTableMap::COL_DATE_OF_BIRTH)) {
            $modifiedColumns[':p' . $index++]  = 'date_of_birth';
        }

        $sql = sprintf(
            'INSERT INTO adult (%s) VALUES (%s)',
    ...
    {
        $pos = AdultTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Adult'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Adult'][$this->hashCode()] = true;
        $keys = AdultTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getGenderId(),
            $keys[2] => $this->getName(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\Adult The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(AdultTableMap::DATABASE_NAME);

        if ($this->isColumnModified(AdultTableMap::COL_ID)) {
            $criteria->add(AdultTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AdultTableMap::COL_GENDER_ID)) {
            $criteria->add(AdultTableMap::COL_GENDER_ID, $this->gender_id);
        }
        if ($this->isColumnModified(AdultTableMap::COL_NAME)) {
            $criteria->add(AdultTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(AdultTableMap::COL_DATE_OF_BIRTH)) {
            $criteria->add(AdultTableMap::COL_DATE_OF_BIRTH, $this->date_of_birth);
        }
    ...
    {
        $criteria = ChildAdultQuery::create();
        $criteria->add(AdultTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\Adult (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\Adult Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aGender === null && ($this->gender_id !== null)) {
            $this->aGender = ChildGenderQuery::create()->findPk($this->gender_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGender->addAdults($this);
             */
        }
     ...
     * If this ChildAdult is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAdult The current object (for fluent API support)
     */
    public function setChildAdults(Collection $childAdults, ConnectionInterface $con = null)
    {
        ...
        foreach ($childAdultsToDelete as $childAdultRemoved) {
            $childAdultRemoved->setAdult(null);
        }
     ...
     * Otherwise if this Adult is new, it will return
     * an empty collection; or if this Adult has previously
     * been saved, it will retrieve related ChildAdults from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Adult.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildChildAdult[] List of ChildChildAdult objects
     */
    public function getChildAdultsJoinChild(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildChildAdultQuery::create(null, $criteria);
    ...
    public function initChildren()
    {
        ...
        $this->collChildren->setModel('\App\Models\Child');
    }
    ...
    /**
     * Gets a collection of ChildChild objects related by a many-to-many relationship
    ...
    /**
     * Sets a collection of Child objects related by a many-to-many relationship
     * to the current object by way of the child_adult cross-reference table.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    /**
     * Gets the number of Child objects related by a many-to-many relationship
     * to the current object by way of the child_adult cross-reference table.
     *
     * @param      Criteria $criteria Optional query object to filter the query
     ...
     * @param      ConnectionInterface $con Optional connection object
     *
     * @return int the number of related Child objects
     */
    ...
    /**
     * Associate a ChildChild to this object
     * through the child_adult cross reference table.
     *
     * @param ChildChild $child
     * @return ChildAdult The current object (for fluent API support)
     */
    public function addChild(ChildChild $child)
    {
    ...
    protected function doAddChild(ChildChild $child)
    {
        ...
        if (!$child->isAdultsLoaded()) {
            $child->initAdults();
            $child->getAdults()->push($this);
        } elseif (!$child->getAdults()->contains($this)) {
            $child->getAdults()->push($this);
        }
    ...
    {
        if ($this->getChildren()->contains($child)) { $childAdult = new ChildChildAdult();

            $childAdult->setChild($child);
            if ($child->isAdultsLoaded()) {
                //remove the back reference if available
                $child->getAdults()->removeObject($this);
            }
    ...
    {
        return (string) $this->exportTo(AdultTableMap::DEFAULT_STRING_FORMAT);
    }
