...
/**
 * Base class that represents a row from the 'child_adult' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class ChildAdult implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\ChildAdultTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\ChildAdult object.
     */
    ...
    /**
     * Compares this with another <code>ChildAdult</code> instance.  If
     * <code>obj</code> is an instance of <code>ChildAdult</code>, delegates to
     * <code>equals(ChildAdult)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ChildAdult The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ChildAdultTableMap::translateFieldName('ChildId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->child_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ChildAdultTableMap::translateFieldName('ParentId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ChildAdultTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\ChildAdult'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildChildAdultQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ChildAdult::setDeleted()
     * @see ChildAdult::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildChildAdultQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ChildAdultTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ChildAdultTableMap::COL_CHILD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'child_id';
        }
        if ($this->isColumnModified(ChildAdultTableMap::COL_PARENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'parent_id';
        }

        $sql = sprintf(
            'INSERT INTO child_adult (%s) VALUES (%s)',
    ...
    {
        $pos = ChildAdultTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['ChildAdult'][$this->hashCode()] = true;
        $keys = ChildAdultTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Models\ChildAdult
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\ChildAdult The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ChildAdultTableMap::COL_CHILD_ID)) {
            $criteria->add(ChildAdultTableMap::COL_CHILD_ID, $this->child_id);
        }
        if ($this->isColumnModified(ChildAdultTableMap::COL_PARENT_ID)) {
            $criteria->add(ChildAdultTableMap::COL_PARENT_ID, $this->parent_id);
        }
    ...
    {
        $criteria = ChildChildAdultQuery::create();
        $criteria->add(ChildAdultTableMap::COL_CHILD_ID, $this->child_id);
        $criteria->add(ChildAdultTableMap::COL_PARENT_ID, $this->parent_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\ChildAdult (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\ChildAdult Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ChildAdultTableMap::DEFAULT_STRING_FORMAT);
    }
