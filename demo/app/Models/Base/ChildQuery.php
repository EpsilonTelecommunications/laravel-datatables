 ...
 * @method     ChildChildQuery orderByGenderId($order = Criteria::ASC) Order by the gender_id column
 * @method     ChildChildQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildChildQuery orderByDateOfBirth($order = Criteria::ASC) Order by the date_of_birth column
 *
 * @method     ChildChildQuery groupById() Group by the id column
 * @method     ChildChildQuery groupByGenderId() Group by the gender_id column
 * @method     ChildChildQuery groupByName() Group by the name column
 * @method     ChildChildQuery groupByDateOfBirth() Group by the date_of_birth column
 *
 ...
 *
 * @method     ChildChildQuery leftJoinGender($relationAlias = null) Adds a LEFT JOIN clause to the query using the Gender relation
 * @method     ChildChildQuery rightJoinGender($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Gender relation
 * @method     ChildChildQuery innerJoinGender($relationAlias = null) Adds a INNER JOIN clause to the query using the Gender relation
 *
 * @method     ChildChildQuery joinWithGender($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Gender relation
 *
 * @method     ChildChildQuery leftJoinWithGender() Adds a LEFT JOIN clause and with to the query using the Gender relation
 ...
 * @method     ChildChild findOneByGenderId(int $gender_id) Return the first ChildChild filtered by the gender_id column
 * @method     ChildChild findOneByName(string $name) Return the first ChildChild filtered by the name column
 * @method     ChildChild findOneByDateOfBirth(string $date_of_birth) Return the first ChildChild filtered by the date_of_birth column *
 ...
 * @method     ChildChild requireOneByGenderId(int $gender_id) Return the first ChildChild filtered by the gender_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildChild requireOneByName(string $name) Return the first ChildChild filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildChild requireOneByDateOfBirth(string $date_of_birth) Return the first ChildChild filtered by the date_of_birth column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildChild[]|ObjectCollection findByGenderId(int $gender_id) Return ChildChild objects filtered by the gender_id column
 * @method     ChildChild[]|ObjectCollection findByName(string $name) Return ChildChild objects filtered by the name column
 * @method     ChildChild[]|ObjectCollection findByDateOfBirth(string $date_of_birth) Return ChildChild objects filtered by the date_of_birth column
...
abstract class ChildQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Models\Base\ChildQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'mysql', $modelName = '\\App\\Models\\Child', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, gender_id, name, date_of_birth FROM child WHERE id = :p0';
        try {
    ...
    public function filterByGenderId($genderId = null, $comparison = null)
    {
        if (is_array($genderId)) {
            ...
            if (isset($genderId['min'])) {
                $this->addUsingAlias(ChildTableMap::COL_GENDER_ID, $genderId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($genderId['max'])) {
                $this->addUsingAlias(ChildTableMap::COL_GENDER_ID, $genderId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ChildTableMap::COL_GENDER_ID, $genderId, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ChildTableMap::COL_NAME, $name, $comparison);
    }
    ...
    public function filterByDateOfBirth($dateOfBirth = null, $comparison = null)
    {
        if (is_array($dateOfBirth)) {
            ...
            if (isset($dateOfBirth['min'])) {
                $this->addUsingAlias(ChildTableMap::COL_DATE_OF_BIRTH, $dateOfBirth['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateOfBirth['max'])) {
                $this->addUsingAlias(ChildTableMap::COL_DATE_OF_BIRTH, $dateOfBirth['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ChildTableMap::COL_DATE_OF_BIRTH, $dateOfBirth, $comparison);
    }
    ...
    public function filterByGender($gender, $comparison = null)
    {
        if ($gender instanceof \App\Models\Gender) {
            return $this
                ->addUsingAlias(ChildTableMap::COL_GENDER_ID, $gender->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ChildTableMap::COL_GENDER_ID, $gender->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
