...
class ChildTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\App\\Models\\Child';
     ...
     */
    const COL_ID = 'child.id';

    /**
     * the column name for the gender_id field
     */
    const COL_GENDER_ID = 'child.gender_id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'child.name';

    /**
     * the column name for the date_of_birth field
     */
    const COL_DATE_OF_BIRTH = 'child.date_of_birth';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ChildTableMap::COL_ID, ChildTableMap::COL_GENDER_ID, ChildTableMap::COL_NAME, ChildTableMap::COL_DATE_OF_BIRTH, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ChildTableMap::COL_ID => 0, ChildTableMap::COL_GENDER_ID => 1, ChildTableMap::COL_NAME => 2, ChildTableMap::COL_DATE_OF_BIRTH => 3, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\Child');
        $this->setPackage('');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ChildTableMap::COL_GENDER_ID);
            $criteria->addSelectColumn(ChildTableMap::COL_NAME);
            $criteria->addSelectColumn(ChildTableMap::COL_DATE_OF_BIRTH);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\Child) { // it's a model object
